...
extension CheckoutVC {
    ...
    func serverHitForRewardLine(){
        ...
        http.requestWithPost(parameters: dict, Url: Endpoints.rewardlines) { (responseData, error) in
    ...
    func serverHitForApplyCoupen(){
        ...
        http.requestWithPost(parameters: dict, Url: Endpoints.apply_coupon) { (responseData, error) in
            DispatchQueue.main.async {
    ...
    func serverHitForCheckOut(){
       ...
       dump(dict)
        http.requestWithPost(parameters: dict, Url: Endpoints.checkout) { (responseData, error) in
            DispatchQueue.main.async {
