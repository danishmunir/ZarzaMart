...
//refreshControl.endRefreshing()
    ...
    func serverHitOrderList(){
        ...
        http.requestWithPost(parameters: dict as [String : Any], Url: Endpoints.ios_com) { (responseData, error) in
...
//        let viewController = storyboard.instantiateViewController(withIdentifier: "ViewAllProductsViewController") as! ViewAllProductsViewController
